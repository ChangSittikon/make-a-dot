...
if len(parts) == 2:
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-0 sm:p-4 text-gray-800">
      <div className="w-full h-[100dvh] sm:h-[850px] sm:w-[430px] bg-brand-gray-light sm:rounded-[40px] sm:shadow-2xl overflow-hidden relative flex flex-col sm:border-[8px] sm:border-gray-900">
        ...
        {/* Mobile Header (replaces Desktop Sidebar) */}
        ...
        <main className="flex-1 flex flex-col relative overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto scrollable-content p-4 relative">
            {loading ? (
              ...
              nodes.length > 0 ? (
                <div className="space-y-4 pb-20 relative z-0">
                ...
                <div className="flex flex-col items-center justify-center h-64 gap-4 text-center px-4">
                  ...
                  <button 
                    ...
                    className="w-full bg-white border border-gray-200 text-gray-700 rounded-xl py-3 px-4 text-xs font-semibold shadow-sm hover:border-gray-300 transition flex items-center justify-between group"
                  >
                    <div className="flex items-center gap-2">
                  ...
                  <button 
                    ...
                    disabled={saving}
                    className="w-full bg-brand-red-50 border border-brand-red/20 text-brand-red rounded-xl py-3 px-4 text-xs font-semibold shadow-sm hover:bg-brand-red hover:text-white transition flex items-center justify-between group disabled:opacity-50"
                  >
                    <div className="flex items-center gap-2">
