...
export function BottomTabBar() {
  ...
  return (
    <div className="sticky bottom-0 w-full bg-white dark:bg-[#1e2329] border-t border-gray-100 dark:border-gray-800 px-6 py-2.5 flex justify-around items-center z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.03)] dark:shadow-none pb-7 sm:pb-2.5 mt-auto transition-colors duration-300">
      {/* Home Tab */}
      <Link href="/" className={`flex flex-col items-center gap-1.5 w-16 transition-colors ${pathname === '/' ? 'text-brand-red' : 'text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-300'}`}>
      ...
      {/* Wallet Tab */}
      <Link href="/wallet" className={`flex flex-col items-center gap-1.5 w-16 transition-colors ${pathname.startsWith('/wallet') ? 'text-brand-red' : 'text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-300'}`}>
      ...
      {/* Explore Tab */}
      <Link href="/explore" className={`flex flex-col items-center gap-1.5 w-16 transition-colors ${pathname === '/explore' ? 'text-brand-red' : 'text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-300'}`}>
      ...
      {/* Admin Tab */}
      <Link href="/admin" className={`flex flex-col items-center gap-1.5 w-16 transition-colors ${pathname.startsWith('/admin') ? 'text-brand-red' : 'text-gray-400 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-300'}`}>
